  ...
  <div class="">
    <div class="">
      ...
      <nav class="flex items-center mb-6 text-sm text-gray-500">
        ...
        <span class="text-[#667eea] hover:text-indigo-400 transition-colors duration-200 no-underline" @click="router.back()">詳細表示</span>
        <span class="mx-3 breadcrumb-separator">
          <i class="fas fa-chevron-right"></i>
        </span>
        <a class="text-[#667eea] hover:text-indigo-400 transition-colors duration-200 no-underline" @click="router.back()">編集</a>
        <span class="breadcrumb-separator">
          <i class="fas fa-chevron-right"></i>
        </span>
        <span class="mx-3 text-gray-900 font-medium">編集</span>
      </nav>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg shadow-black/8 border border-gray-200 p-8 mb-6 transition-all duration-300 hover:shadow-xl hover:shadow-black/12 hover:-translate-y-0.5">
          <div class="flex flex-col sm:flex-row justify-between gap-4">
            ...
            <div class="flex gap-4">
              <button type="submit" class="inline-flex items-center justify-center px-6 py-3 text-sm font-medium rounded-lg transition-all duration-200 text-white bg-gradient-to-br from-[#667eea] to-[#764ba2] shadow-lg shadow-indigo-500/40 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-indigo-500/50 cursor-pointer">
...
const handleSubmit = () => {
  console.log('Form submitted:', detailData)
